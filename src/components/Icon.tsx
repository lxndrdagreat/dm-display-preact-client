import { createRef, h, RenderableProps } from 'preact';
...
function Icon(props: RenderableProps<Props>) {
  const { name } = props;
  if (name === 'shield') {
    return (
